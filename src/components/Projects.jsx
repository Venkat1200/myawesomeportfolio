...
const Projects = () => {
  return (
    <div name="projects" className="w-full h-full bg-gray-100">
      <div className="max-w-7xl mx-auto p-4">
        <div className="py-4">
          <h1 className="text-4xl font-bold border-b-2 border-black">
            Projects
          </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          <div className="bg-white border  border-red-700 rounded-lg shadow-md p-2 sm:p-4">
            <img
              src={INDISH}
              alt="Indish E-commerce"
              className="w-full h-32 sm:h-36 mb-4 rounded-lg"
            />
